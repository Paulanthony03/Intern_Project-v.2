  ...
  Widget _statusBadge(String status) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isOngoing ? const Color(0xFF1E3A1E) : const Color(0xFF2A2A2A),
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child:
                      const Icon(Icons.close, color: textMuted, size: 20),
                ),
              ),
            ],
          ),
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: _hovered
                ? [
                    BoxShadow(
                      color: const Color.fromARGB(255, 212, 226, 74),
                      spreadRadius: 1,
                    ),
                  ]
                : [],
