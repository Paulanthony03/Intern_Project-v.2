...
class _AdminInternsState extends State<AdminInterns> {
  ...
  void showEditDialog(Map<String, dynamic> user) {
    ...
    final deptCtrl    = TextEditingController(text: user["department"] ?? user["dept"] ?? "");
    bool isSaving = false;
                            ...
                            onPressed: isSaving
                                ...
                                : () async {
                                    ...
                                    try {
                                      ...
                                      await ApiService.updateUser(widget.token, userId, updatedData);
                                      await widget.onRefresh?.call();
                                      Navigator.pop(ctx);
                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
  ...
  Widget _editField(String label, TextEditingController ctrl) {
    return Column(
      ...
      children: [
        Text(
          label,
          style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: accent),
        ),
  ...
  Widget _infoRow(String label, String value) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(value, style: const TextStyle(color: textMain, fontSize: 13)),
        ),
      ],
    );
  }
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          icon: const Icon(Icons.visibility, color: pageBg, size: 16),
                          label: const Text(
                            "View",
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          icon: const Icon(Icons.delete_outline, color: textMain, size: 16),
                          label: const Text(
                            "Delete",
    ...
    return _styledDropdown<String?>(
      ...
      items: [
        const DropdownMenuItem<String?>(
          value: null,
          child: Text("All Departments", style: TextStyle(color: textMain, fontSize: 13),
          ),),
        ...allDepartments.map(
  ...
  Widget _buildSchoolDropdown() {
    return _styledDropdown<String?>(
      ...
      items: [
        const DropdownMenuItem<String?>(
          value: null,
          child: Text("All Schools", style: TextStyle(color: textMain, fontSize: 13),
          overflow: TextOverflow.ellipsis, 
          maxLines: 1,
          ),
        ),
              ...
              Expanded(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: const Text(
                      "Add Intern",
                      style: TextStyle(color: pageBg, fontSize: 14, fontWeight: FontWeight.bold),
                    ),
                   onPressed: () async {
